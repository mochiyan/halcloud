...
public final class news_005fupdatein_jsp extends org.apache.jasper.runtime.HttpJspBase
...
try{//ロードに失敗したときのための例外処理
    ...
    while(rs.next()){
      ...
      out.write("    <title>お知らせ編集画面</title>\r\n");
   ...
   for(int i=0;i<list.size();i++){
      ...
      out.write("        <form action=\"news_updateout.jsp\" method=\"post\" class=\"cp_group\">\r\n");
      out.write("\t        <div class=\"title\">\r\n");
      out.write("\t        <h2>お知らせ編集</h2>\r\n");
      out.write("\t     \t</div>\r\n");
      out.write("\t     \t<input type=\"hidden\" name=\"news_id\" value=\"");
      out.print( list.get(i).get("news_id") );
      out.write("\">\r\n");
      out.write("\t        <div class=\"cp_tx\">\r\n");
      out.write("\t        <label class=\"title\">日付(例: 2029/12/01):</label>\r\n");
      ...
      out.write("\t        <input class=\"large\" type=\"text\" name=\"news_name\" placeholder=\"");
      out.print( list.get(i).get("news_name") );
      out.write("\"required>\r\n");
      out.write("\t        </div>\r\n");
      out.write("\t        <div class=\"cp_textarea\">\r\n");
      out.write("\t        <label class=\"title\">お知らせ内容:</label>\r\n");
      out.write("\t        <textarea name=\"news_txt\" cols=\"70\" style=\"height: 100px;\" required>");
      out.print( list.get(i).get("news_txt") );
      out.write("</textarea>\r\n");
      out.write("\t        </div>\r\n");
      out.write("\t\r\n");
      out.write("\t        <div class=\"submit\">\r\n");
      out.write("\t        <input type=\"submit\" value=\"更新する\" />\r\n");
      out.write("\t        </div>\r\n");
      out.write("        </form>\r\n");
      out.write("      </div>\r\n");
