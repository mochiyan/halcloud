...
public final class foodsearch_jsp extends org.apache.jasper.runtime.HttpJspBase
...
//文字コードの指定
        ...
        String shop_searchStr = request.getParameter("search");
        ...
        //SQL文の発行(選択クエリ)
		 	PreparedStatement st=con.prepareStatement("SELECT * FROM shop_tbl WHERE shop_name LIKE ? or shop_category LIKE ?or shop_txt LIKE ?");
			st.setString(1,"%" + shop_searchStr + "%");
			st.setString(2,"%" + shop_searchStr + "%");
			st.setString(3,"%" + shop_searchStr + "%");
			rs = st.executeQuery();
 ...
 if(ERMSG != null){ 
      ...
      out.write("          \t<div class=\"searchhead\">\r\n");
      out.write("          \t\t");
      out.print(shop_searchStr);
      out.write("の検索結果\r\n");
      out.write("          \t</div>\r\n");
      out.write("    ");
