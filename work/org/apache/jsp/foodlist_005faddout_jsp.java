...
public final class foodlist_005faddout_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\r\n");
        ...
        String post_usersStr = request.getParameter("post_users");
        ...
        //SQL文の構築
        SQL.append("select * from post_tbl where post_id = null ");
        ...
        if(rs.next()){//存在する(追加NG)
            ...
            //SQL文の構築(DB追加)
            SQL.append("insert into post_tbl(post_name,post_address,post_tel,post_category,post_star,post_users,post_txt)");
            SQL.append(" value('");
    ...
    if(hit_flag == 1){ //追加NG
      ...
      out.write("\r\n");
      out.write("    <div class=\"txt\">追加処理が失敗しました</div>\r\n");
      ...
      out.write("\r\n");
      out.write("    <div class=\"txt\"> 追加が完了しました</div>\r\n");
      ...
      out.write("          <form method=\"post\" action=\"foodlist.jsp\">\r\n");
      out.write("            <p><input type=\"submit\" value=\"申請一覧に戻る\"></p>\r\n");
      out.write("          </form>\r\n");
      out.write("        </div>\r\n");
      out.write("        </div>\r\n");
      out.write("        \r\n");
